...
namespace DotNet.IDAL
{
    public interface IBaseDal<T> where T : class, new()
    {
        ...
        /// <returns>整数值</returns>
        double GetMax(string columnName);
        ...
        /// <returns></returns>
        bool Exists(object primarykeyValue);
        ...
        /// <returns>成功为True</returns>
        bool DeleteList(IList<object> primarykeyValues);
        ...
        DataTable GetTablePaged(int pageIndex, int pageSize, out int totalCount, string strWhere, Dictionary<string, SqlSortEnum> orderBy);
        ///// <summary>
        ///// 添加一条数据
        ///// </summary>
        ///// <param name="entity">实体模型</param>
