...
namespace DotNet.Common.Cache.Redis
{
    public sealed class RedisConfig : ConfigurationSection
    {
        ...
        /// 可写的Redis链接地址
        /// </summary>
        [ConfigurationProperty("WriteServerConStr", DefaultValue="127.0.0.1:6379", IsRequired = false)]
        ...
        /// 可读的Redis链接地址
        /// </summary>
        [ConfigurationProperty("ReadServerConStr", DefaultValue="127.0.0.1:6379", IsRequired = false)]
